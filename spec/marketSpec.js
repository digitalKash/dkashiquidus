describe('market', function() {
  ...
  describe('poloniex', function() {
    ...
    it('should return trade history', function(done){
      poloniex.get_trades('DKASH', 'BTC', function(err, trades) {
    ...
    it('should return orderbook', function(done){
      poloniex.get_orders('DKASH', 'BTC', function(err, orders) {
        expect(err).toEqual(null);
    ...
    it('should return summary', function(done){
      poloniex.get_summary('DKASH', 'BTC', function(err, summary) {
        expect(err).toEqual(null);
    ...
    it('should return chartdata', function(done){
      poloniex.get_chartdata('DKASH', 'BTC', 0, function(err, chartdata) {
        expect(err).toEqual(null);
